...
* **hatari/src/str.c**
  * Removed `setlocale` to fix interference with numeric parsing in the host process using a shared C runtime. ([83](https://github.com/bbbradsmith/hatariB/issues/83#issuecomment-5574047800))
* **hatari/src/tos.c**
