...
* [EmuTOS/](https://emutos.sourceforge.io/) 1.4 2025-06-07 ([customized version](https://github.com/bbbradsmith/emutos/tree/hatarib-custom-140))
...
* **hatari/src/floppy_ipf.c**
  ...
  * Suppress savestate pointer data to prevent divergence.
  * Suppress `-Wchar-subscripts` passing `char` to `isdigit`.
...
* **hatari/src/str.c**
  * Changed `setlocale` from `LC_ALL` to `LC_CTYPE` to fix interference with numeric parsing in the host process using a shared C runtime. ([83](https://github.com/bbbradsmith/hatariB/issues/83#issuecomment-5574047800))
* **hatari/src/tos.c**
